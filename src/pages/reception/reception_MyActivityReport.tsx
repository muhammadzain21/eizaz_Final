    ...
    <body>
      ...
      <div class="header">
        ...
        <div class="kpis">
          ...
          <div class="kpi"><div class="k">Lab Carts</div><div class="v">${escHtml(money(summary?.labCarts?.total || 0))}</div><div class="s">Count: ${escHtml(summary?.labCarts?.count ?? 0)}</div></div>
